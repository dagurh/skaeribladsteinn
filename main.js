...
document
  ...
  .addEventListener('click', () => round('click'));
// Event listeners fyrir skæri, blað, steinn takka
// TODO
document
  .querySelector('button.scissor')
  .addEventListener('click', () => show('result'), () => checkGame(1, computerPlay));

document
  .querySelector('button.paper')
  .addEventListener('click', () => show('result'), () => checkGame(2, computerPlay));

document
  .querySelector('button.rock')
  .addEventListener('click', () => show('result'), () => checkGame(3, computerPlay));
/**
